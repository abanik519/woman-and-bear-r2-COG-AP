              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s3" className="speech2">
                    I think the bear is sad and afraid, being alone on the ice
                    like that.
                  </div>
                </div>
              </div>
              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s4" className="speech2">
                    The word bond means that two things are stuck together, as
                    when you glue two pieces of paper together. We also use this
                    word when two people become very close friends: we say they
                    have bonded.
                  </div>
                </div>
              </div>
              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s5" className="speech2">
                    The old woman was lonely in the past when she had no family.
                    Now she is never lonely because Kunik and his friends keep
                    her company.
                  </div>
                </div>
              </div>
              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s7" className="speech2">
                    Sometimes we get jeolous when another person has more things
                    or more skill than we have.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s9" className="speech2">
                    We know that Kunik is sad to obey his mother because he has
                    tears in his eyes.
                  </div>
                </div>
              </div>
            ...
            <div className="slide fade">
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  >
                    The old woman must have loved Kunik very much because she
                    walked for hours to find him in the cold.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="image-container">
                ...
                <div className="avatar-container">
                  ...
                  <div id="s11" className="speech2">
                    This is a good ending to the story! Before the villagers
                    were afraid of Kunik but now they respect him.
                  </div>
                </div>
              </div>
            </div>
